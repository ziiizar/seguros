...
export function DropdownMenu({
  ...
  const items = [
    { icon: <Mail size={16} />, name: "Contact by email" },
    { icon: <PhoneCall size={16} />, name: "Contact by whatsapp" },
    ...
    >
      ...
      >
        ...
        <div style={{ transformOrigin: "50% 55%" }}>
          <EllipsisVertical size={14} className="text-neutral-400" id="menu-icon" />
        </div>
      </motion.button>
      <ul
        className={cn(

...
export default function renderField  ({field,answers,setAnswers}:{field: Field, answers: Record<string, string>, setAnswers: Dispatch<Record<string, string>>}) {
    switch (field.type) {
      case "short_text":
      case "email":
      case "website":
      ...
      case "multiple_choice":
        return (
          ...
          >
            {field.properties.choices && field.properties.choices.map((choice, index) => (
              <Label
                key={index}
